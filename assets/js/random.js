...
var pistas = [
  ...
  {id:9, nombre:'Circuito de Daisy', copa:copas[2]},
  {id:10, nombre:'Colina Koopa', copa:copas[2]},
  ...
  {id:14, nombre:'Circuito de la Luz', copa:copas[3]},
  {id:15, nombre:'Castillo de Bowser', copa:copas[3]},
  {id:16, nombre:'Senda Arco Iris', copa:copas[3]},
  {id:17, nombre:'GCN Playa de Peach', copa:copas[4]},
  {id:18, nombre:'DS Cataratas de Yoshi', copa:copas[4]},
  {id:19, nombre:'SNES Valle Fantasmal 2', copa:copas[4]},
